...
export default function Footer() {
  return (
    <footer className="bg-black text-white border-t border-[#262626]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#features" className="text-[#A6A6A6] hover:text-white transition-colors">
                  特色功能
                </a>
              </li>
              <li>
                <a href="#services" className="text-[#A6A6A6] hover:text-white transition-colors">
                  我们的服务
                </a>
              </li>
              <li>
                <a href="#about" className="text-[#A6A6A6] hover:text-white transition-colors">
                  关于我们
                </a>
              </li>
              <li>
                <a href="#contact" className="text-[#A6A6A6] hover:text-white transition-colors">
                  联系我们
                </a>
              </li>
            </ul>
